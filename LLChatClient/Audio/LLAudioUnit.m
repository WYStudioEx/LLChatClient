...
// PCM -> AAC
//AudioBufferList* convertPCMToAAC (LLAudioUnit *recoder) {
//    
//    
//}
#pragma mark 转码
AudioBufferList* convertPcmToAAcPCMdata(void * pcmdata){
    ...
    // 在此处由于编码器特性,必须给编码器1024帧才能完成一次转换, 也就是刚刚在采集数据回调中存储的pcm_buffer
...
//-(NSMutableData *)receveData
//{
//    if (!_receveData) {
//        _receveData = [NSMutableData new];
//    }
//    return _receveData;
//}
